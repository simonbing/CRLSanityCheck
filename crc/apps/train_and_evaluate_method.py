...
flags.DEFINE_enum('dataset', 'lt_camera_v1', ['lt_camera_v1', 'contrast_synthetic',
                                              ...
                                              'multiview_synthetic_chambers_scm'], 'Dataset.')
...
def main(argv):
    ...
    match FLAGS.method:
        ...
        case 'multiview':
            ...
            elif FLAGS.dataset == 'multiview_synthetic_2':
                FLAGS.encoder = ['fc', 'fc', 'fc']
                kwarg_dict = {
                    'in_dims': [2, 2, 2],
                    'selection': FLAGS.selection,
                    'tau': FLAGS.tau
                }
            elif FLAGS.dataset == 'multiview_synthetic_reprod':
                FLAGS.encoder = ['fc', 'fc', 'fc', 'fc']
                kwarg_dict = {
            ...
            elif FLAGS.dataset == 'multiview_synthetic_chambers_indep':
                FLAGS.encoder = ['fc', 'fc', 'fc', 'fc']
                kwarg_dict = {
                    'in_dims': [5, 3, 1, 1],
                    'selection': FLAGS.selection,
            ...
            elif FLAGS.dataset == 'multiview_synthetic_chambers_scm':
                FLAGS.encoder = ['fc', 'fc', 'fc', 'fc']
                kwarg_dict = {
                    'in_dims': [5, 3, 1, 1],
                    'selection': FLAGS.selection,
