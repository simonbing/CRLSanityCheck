...
do
  SEED=$RANDOM
  sbatch --wrap="python ../train.py --model contrast_crl --dataset lt_camera_v1 --experiment scm_2 \
   --batch_size 512 --epochs 1 --seed ${SEED} --lat_dim 5 --run_name contrast_crl_no_changes_4k \
