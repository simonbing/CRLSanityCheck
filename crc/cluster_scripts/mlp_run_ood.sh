...
do
  SEED=$RANDOM
  sbatch cluster_gpu.sh python ../run_ood.py --estimation_model mlp --task lt_pcl_2 \
   --batch_size 512 --epochs 100 --learning_rate 0.001 --seed $SEED --image_data --run_name mlp_ood_lt_2_1 \
