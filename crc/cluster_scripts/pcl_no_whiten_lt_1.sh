...
do
  SEED=$RANDOM
  sbatch cluster_gpu.sh python ../run_experiment.py --model pcl --dataset lt_camera_walks_v1 --task lt_pcl_1 \
   --batch_size 512 --epochs 100 --seed $SEED --image_data --conv --lat_dim 5 --run_name pcl_no_whiten_conv_lt_2 \
