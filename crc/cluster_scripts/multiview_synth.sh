...
SEED=$RANDOM
  ...
  --dataset multiview_synthetic_chambers_scm --task lt_scm_2 --epochs 500 --val_step 10 \
  --bs 4096 --lr 0.0001 --lat_dim 5 --seed $SEED --run_name multiview_synth_chambers_scm_0 \
