...
--dataset multiview_synthetic_chambers_indep --task lt_scm_2 --epochs 2000 --val_step 100 \
--bs 4096 --lr 0.0001 --lat_dim 5 --seed $SEED --run_name multiview_synth_chambers_indep_0 \
