...
do
  ...
  --dataset lt_crl_benchmark_v1 --task contrast_crl_real --exp_name buchholz_1 --train_steps 30000 \
  --batch_size 512 --lr 0.0001 --lat_dim 5 --seed $SEED --run_name multiview_chambers_0 \
