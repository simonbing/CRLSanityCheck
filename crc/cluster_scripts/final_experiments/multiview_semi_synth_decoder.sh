...
do
  ...
  --dataset chambers_semi_synth_decoder --task chambers_semi_synth --exp_name scm_2 --train_steps 65000 \
  --batch_size 128 --lr 0.0001 --lat_dim 5 --seed $SEED --run_name multiview_semi_synth_dec_1 \
