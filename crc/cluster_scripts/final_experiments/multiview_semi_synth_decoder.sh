...
do
  ...
  --dataset chambers_semi_synth_decoder --task chambers_semi_synth_add_sens --exp_name buchholz_1_synth_det --train_steps 28500 \
  --batch_size 512 --lr 0.0001 --lat_dim 5 --seed $SEED --run_name multiview_semi_synth_dec_add_sensors_0 \
